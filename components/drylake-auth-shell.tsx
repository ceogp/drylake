...
export const clerkTapeAppearance = {
  ...
  elements: {
    ...
    modalContent: "border border-zinc-800 bg-[#111414] text-zinc-100 shadow-none",
    otpCodeFieldInput: "border border-zinc-700 bg-[#090a0a] text-zinc-100",
    popoverBox: "border border-zinc-800 bg-[#111414] text-zinc-100 shadow-none",
    ...
    userButtonPopoverActionButton: "text-zinc-100 hover:bg-zinc-900",
    userButtonPopoverActionButtonIcon: "text-zinc-300",
    userButtonPopoverActionButtonText: "text-zinc-100",
    userButtonPopoverCard: "border border-zinc-800 bg-[#111414] text-zinc-100 shadow-none",
