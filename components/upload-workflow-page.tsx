...
export async function UploadWorkflowPage({ versionId }: { versionId: string }) {
      ...
      label:
        job.jobType === "import_parse"
          ...
          : job.jobType === "export_build"
            ...
            : job.jobType === "canonicalize"
              ? "Canonicalized with Kimi"
          ...
          <div className="flex flex-wrap items-end justify-between gap-6">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-lg leading-8 text-stone-700">
                Import, view, and organize your AI coding agents and skills.
              </p>
            </div>
        ...
        <section className="space-y-6">
          <VersionTools
            currentSummary={{
              ...
              canonicalItems: importedItems.filter((item) => item.canonicalized).length,
              lastImportAt:
