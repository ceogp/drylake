...
const serverEnvSchema = z.object({
  ...
  OPERATOR_PORTAL_INTERNAL_HOST: z.string().optional(),
  OPERATOR_PORTAL_INTERNAL_ORIGIN: z.string().optional(),
  OPERATOR_PORTAL_BASIC_AUTH_USERNAME: z.string().optional(),
  OPERATOR_PORTAL_BASIC_AUTH_PASSWORD: z.string().optional(),
  ...
  AWS_COGNITO_REGION: z.string().optional(),
  ...
  AWS_COGNITO_ISSUER: z.url().optional(),
  AWS_COGNITO_CALLBACK_URL: z.url().optional(),
  AWS_COGNITO_LOGOUT_REDIRECT_URL: z.url().optional(),
  ...
  XUPRA_TRUST_REGISTRY_BASE_URL: z.url().default("https://xupracorp.com"),
  XUPRA_TRUST_KMS_KEY_ID: z.string().optional(),
  XUPRA_TRUST_KMS_SIGNING_ALGORITHM: z.enum([
    "RSASSA_PSS_SHA_256",
    "RSASSA_PSS_SHA_384",
    "RSASSA_PSS_SHA_512",
  ...
  XUPRA_TRUST_PUBLICATION_DRIVER: z.enum(["database", "local", "s3"]).default("database"),
  XUPRA_TRUST_PUBLICATION_BUCKET: z.string().optional(),
  XUPRA_TRUST_PUBLICATION_PREFIX: z.string().default("kya-registry"),
  XUPRA_TRUST_STRIPE_MONTHLY_PRODUCT_ID: z.string().optional(),
  ...
  STRIPE_SECURITY_PRO_PRICE_ID: z.string().optional(),
  STRIPE_TEAM_SECURITY_PRICE_ID: z.string().optional(),
  STRIPE_ENTERPRISE_PRICE_ID: z.string().optional(),
  BILLING_ENFORCEMENT_MODE: z.enum(["development", "strict"]).default("development"),
  CONTINUOUS_WATCH_CRON_SECRET: z.string().optional(),
