...
async function writeStagingEnv(manifest: Manifest) {
  ...
  const values: Record<string, string> = {
    ...
    ADMIN_INTERNAL_BASIC_AUTH_USERNAME: process.env.ADMIN_INTERNAL_BASIC_AUTH_USERNAME || "",
    ADMIN_INTERNAL_BASIC_AUTH_PASSWORD: process.env.ADMIN_INTERNAL_BASIC_AUTH_PASSWORD || "",
