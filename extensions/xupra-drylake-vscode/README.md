...
![DryLake Guard security workflow](https://drylake.xupracorp.com/marketplace/extension/media/guard-security.gif)
...
![DryLake agent control workflow](https://drylake.xupracorp.com/marketplace/extension/media/agent-control.gif)
