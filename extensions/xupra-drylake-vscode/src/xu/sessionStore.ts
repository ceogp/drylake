...
export class XuSessionStore {
  ...
  getDefaultRunbookUri() {
    return vscode.Uri.joinPath(resolveWorkspaceRoot(), "drylake.xu");
  }
  ...
  async createSession(params: {
    ...
    const uri = vscode.Uri.joinPath(resolveWorkspaceRoot(), ".drylake", "sessions", id, "session.json");
  ...
  async readPendingPlanChange(): Promise<PendingPlanChangeSet | null> {
    const uri = vscode.Uri.joinPath(resolveWorkspaceRoot(), ".drylake", "pending-plan-changes", "current.json");
    let text = "";
  ...
  async archiveCurrentRunbook() {
    ...
    const id = timestampId();
    const folder = vscode.Uri.joinPath(resolveWorkspaceRoot(), ".drylake", "sessions", id);
  ...
  async clearPendingPlanChanges() {
    const folder = vscode.Uri.joinPath(resolveWorkspaceRoot(), ".drylake", "pending-plan-changes");
    try {
  ...
  async listArchivedSessions() {
    const folder = vscode.Uri.joinPath(resolveWorkspaceRoot(), ".drylake", "sessions");
  ...
  async restoreArchivedSession(sessionId: string) {
    ...
    const archivedRunbookUri = vscode.Uri.joinPath(resolveWorkspaceRoot(), ".drylake", "sessions", safeId, "drylake.xu");
